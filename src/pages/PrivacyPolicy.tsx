    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-6 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Content */}
          <div className="prose prose-lg max-w-none text-left prose-h2:py-6 prose-h3:py-4 prose-h4:py-2 prose-h2:text-3xl prose-h3:text-2xl prose-h4:text-lg prose-h2:font-bold prose-h3:font-bold prose-h4:font-medium">
            {isEditing ? (
              <Textarea
                value={editContent}
